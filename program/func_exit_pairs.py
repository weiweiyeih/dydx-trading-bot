...
def manage_trade_exits(client):
    ...
    for position in open_positions_dict:
        ...
        # Get markets for refrence of tick size
        ...
        if CLOSE_AT_ZSCORE_CROSS:
            ...
            # Determine trigger: cross -(z_score_traded) or cross zero
            ...
            print("=====")
            print(f"Checking z-score of pair: {position_market_m1} & {position_market_m2}")
